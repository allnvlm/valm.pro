...
|---|---|---|
| `section_view` | `section` | How far people read. Once per section: `patterns`, `what_you_get`, `honest_part`, `how_it_starts`, `track_record`, `first_session`, `contact`, `readiness_contact` |
